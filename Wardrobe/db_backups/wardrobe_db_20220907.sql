...
--
-- Host: db
-- Erstellungszeit: 07. Sep 2022 um 09:26
...
--
-- Tabellenstruktur für Tabelle `wardrobe_gpio_REF`
--

CREATE TABLE `wardrobe_gpio_REF` (
...
--
-- Daten für Tabelle `wardrobe_gpio_REF`
--

INSERT INTO `wardrobe_gpio_REF` (`wardrobe_fk`, `pos_column`, `pos_row`, `pin`) VALUES
(1, 1, 1, 5);
...
--
-- Indizes für die Tabelle `wardrobe_gpio_REF`
--
ALTER TABLE `wardrobe_gpio_REF`
  ADD PRIMARY KEY (`wardrobe_fk`,`pos_column`,`pos_row`);
...
--
-- Constraints der Tabelle `wardrobe_gpio_REF`
--
ALTER TABLE `wardrobe_gpio_REF`
  ADD CONSTRAINT `wardrobe_gpio_ref_ibfk_1` FOREIGN KEY (`wardrobe_fk`) REFERENCES `wardrobe` (`id`);
